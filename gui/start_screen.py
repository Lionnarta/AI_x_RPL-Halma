...
def start():
    ...
    while event_running:
        ...
        image_pvbl_a = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "PvBl_active.png"))
        image_pvbl_a = pygame.transform.scale(image_pvbl_a, (250, 100))
        image_pvbl_u = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "PvBl_unactive.png"))
        ...
        # Time box
        time_limit = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "time_limit.png"))
        ...
        if input_active:
            time_box =  pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "time_box_a.png"))
            screen.blit(time_box, (width/2-265, height/2+210))
        else:
            time_box =  pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "time_box_u.png"))
            screen.blit(time_box, (width/2-265, height/2+210))
        
        # Player
        player = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "player.png"))
        if active == 0 or active == 1:
            screen.blit(player, (width/2-425, height/2+265))
        # Player color selection
        green_a = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "green_a.png"))
        green_a = pygame.transform.scale(green_a, (60, 60))
        green_u = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "green_u.png"))
        green_u = pygame.transform.scale(green_u, (60, 60))
        red_a = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "red_a.png"))
        red_a = pygame.transform.scale(red_a, (60, 60))
        red_u = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "red_u.png"))
        ...
        # Play button
        play = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "play.png"))
        play = pygame.transform.scale(play, (120, 60))
        play_h = pygame.image.load(os.path.join(os.path.dirname(os.getcwd()), "img", "collection", "play_h.png"))
        play_h = pygame.transform.scale(play_h, (120, 60))
        # Play pos
        play_pos = Rect(width/2+width/4, height/2+300, 120, 60)
        # show play
        if(width/2+width/4 <= mouse[0] <= width/2+width/4+120) and (height/2+300 <= mouse[1] <= height/2+360):
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if(pvb_position.collidepoint(mouse[0], mouse[1])) and (active != 0):
                    ...
                    screen.blit(image_bvb_u, bvb_position)
                    active = 0
                if(pvbl_position.collidepoint(mouse[0], mouse[1])) and (active != 1):
                    screen.blit(image_pvb_u, pvb_position)
                    screen.blit(image_pvbl_a, pvbl_position)
                    screen.blit(image_bvb_u, bvb_position)
                    active = 1
                if(bvb_position.collidepoint(mouse[0], mouse[1])) and (active != 2):
                    screen.blit(image_pvb_u, pvb_position)
                    screen.blit(image_pvbl_u, pvbl_position)
                    screen.blit(image_bvb_a, bvb_position)
                    active = 2
                ...
                if(time_box_pos.collidepoint(mouse[0], mouse[1])):
                    ...
                    input_active = False
                # player
                if(green_pos.collidepoint(mouse[0], mouse[1])) and player_default == 2 and (active == 0 or active == 1):
                    screen.blit(green_a, green_pos)
                    screen.blit(red_u, red_pos)
                    player_default = 1
                if(red_pos.collidepoint(mouse[0], mouse[1])) and player_default == 1 and (active == 0 or active == 1):
                    screen.blit(green_u, green_pos)
                    screen.blit(red_a, red_pos)
                    player_default = 2
